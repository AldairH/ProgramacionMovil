...
public class Galeria extends JFrame implements ActionListener{
    ...
    public Galeria(){
        ...
        images = new ImageIcon[]{
            new ImageIcon(getClass().getResource("/galeria/imagenes/imagen1.jpg")),
            new ImageIcon(getClass().getResource("/galeria/imagenes/imagen2.jpg")),
            new ImageIcon(getClass().getResource("/galeria/imagenes/imagen3.jpg"))
        };
